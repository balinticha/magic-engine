...
public class AddComponentCommand : ConsoleCommand
{
    ...
    public override string Description =>
        "Adds a component with the default configuration. Usage: addcomp <target> <component>";
    ...
    public override string Execute(string[] args)
    {
        ...
        try
        {
            ...
            {
                return
                    $"Error: Could not create an instance of '{component.Name}'. Does it have a default constructor?";
            }
