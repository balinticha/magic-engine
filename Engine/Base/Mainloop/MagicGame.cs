...
public abstract class MagicGame : Game
{
    ...
    protected override void Initialize()
    {
        ...
        _commandManager = new CommandManager(SystemManager, SceneManager, PrototypeManager, _random, CameraSystem,
            LogManager, EngineGraphicsModule.PostProcessingManager);
    ...
    protected override void Draw(GameTime gameTime)
    {
        try
        {
            ...
            inputManager.IsInputDisabled =
                _hasCrashed || (EngineDebugModule.WantsCaptureKeyboard && EngineDebugModule.DebugEnabled);
